...
<>
    <div className="all-divs-outer w-full min-h-[100vh] bg-black">
           ...
           <div className="about-hero w-full h-[100vh] bg-black flex justify-center items-center">
                ...
                <p className="hero-subtitle text-white font-thin text-[6vw] sm:text-[5vw] md:text-[4vw] lg:text-[3vw]">Its me Rameez!</p>
       </div>
       </div>
       ...
       <Accordion type="single" className="w-[70%] mx-auto" collapsible>
          ...
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <p>
                ...
                which led me to pursue a career in web development. Over the years Ive honed my skills through hands-on
                ...
                developer Im driven by the desire to build functional user-friendly and aesthetically pleasing websites that
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              <p>
                Beyond Code My Hobbies & Interests When Im not coding I enjoy exploring a variety of hobbies that help
                me unwind and stay inspired. Whether is reading the latest tech blogs experimenting with new frameworks or
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              <p>
                My Professional Experience Over the past several years ve had the privilege of working on diverse web
